...
var file_account_v1_account_service_proto_rawDesc = []byte{
	...
	0x22, 0xca, 0x02, 0x0a, 0x1b, 0x47, 0x65, 0x74, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x41, 0x63, 0x63,
	...
	0x77, 0x6e, 0x65, 0x72, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0x94, 0x03,
	...
	0x4e, 0x44, 0x10, 0x01, 0x22, 0x8f, 0x0c, 0x0a, 0x10, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x41, 0x63,
	...
	0x08, 0x0a, 0x10, 0x0b, 0x4a, 0x04, 0x08, 0x0e, 0x10, 0x0f, 0x4a, 0x04, 0x08, 0x0f, 0x10, 0x10,
	0x4a, 0x04, 0x08, 0x10, 0x10, 0x11, 0x32, 0xde, 0x01, 0x0a, 0x07, 0x41, 0x63, 0x63, 0x6f, 0x75,
...
var file_account_v1_account_service_proto_depIdxs = []int32{
	...
	1,  // 7: code.account.v1.GetTokenAccountInfosResponse.result:type_name -> code.account.v1.GetTokenAccountInfosResponse.Result
	11, // 8: code.account.v1.GetTokenAccountInfosResponse.token_account_infos:type_name -> code.account.v1.GetTokenAccountInfosResponse.TokenAccountInfosEntry
	12, // 9: code.account.v1.TokenAccountInfo.address:type_name -> code.common.v1.SolanaAccountId
	12, // 10: code.account.v1.TokenAccountInfo.owner:type_name -> code.common.v1.SolanaAccountId
	12, // 11: code.account.v1.TokenAccountInfo.authority:type_name -> code.common.v1.SolanaAccountId
	14, // 12: code.account.v1.TokenAccountInfo.account_type:type_name -> code.common.v1.AccountType
	2,  // 13: code.account.v1.TokenAccountInfo.balance_source:type_name -> code.account.v1.TokenAccountInfo.BalanceSource
	3,  // 14: code.account.v1.TokenAccountInfo.management_state:type_name -> code.account.v1.TokenAccountInfo.ManagementState
	4,  // 15: code.account.v1.TokenAccountInfo.blockchain_state:type_name -> code.account.v1.TokenAccountInfo.BlockchainState
	5,  // 16: code.account.v1.TokenAccountInfo.claim_state:type_name -> code.account.v1.TokenAccountInfo.ClaimState
	15, // 17: code.account.v1.TokenAccountInfo.original_exchange_data:type_name -> code.transaction.v2.ExchangeData
	12, // 18: code.account.v1.TokenAccountInfo.mint:type_name -> code.common.v1.SolanaAccountId
	16, // 19: code.account.v1.TokenAccountInfo.created_at:type_name -> google.protobuf.Timestamp
	10, // 20: code.account.v1.GetTokenAccountInfosResponse.TokenAccountInfosEntry.value:type_name -> code.account.v1.TokenAccountInfo
	6,  // 21: code.account.v1.Account.IsCodeAccount:input_type -> code.account.v1.IsCodeAccountRequest
	8,  // 22: code.account.v1.Account.GetTokenAccountInfos:input_type -> code.account.v1.GetTokenAccountInfosRequest
	7,  // 23: code.account.v1.Account.IsCodeAccount:output_type -> code.account.v1.IsCodeAccountResponse
	9,  // 24: code.account.v1.Account.GetTokenAccountInfos:output_type -> code.account.v1.GetTokenAccountInfosResponse
