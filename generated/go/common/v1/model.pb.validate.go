...
// Validate checks the field values on VirtualInstruction with the rules
// defined in the proto definition for this message. If any rules are
// violated, an error is returned.
func (m *VirtualInstruction) Validate() error {
	if m == nil {
		return nil
	}

	if l := len(m.GetValue()); l < 1 || l > 1232 {
		return VirtualInstructionValidationError{
			field:  "Value",
			reason: "value length must be between 1 and 1232 bytes, inclusive",
		}
	}
...
// VirtualInstructionValidationError is the validation error returned by
// VirtualInstruction.Validate if the designated constraints aren't met.
type VirtualInstructionValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e VirtualInstructionValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e VirtualInstructionValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e VirtualInstructionValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e VirtualInstructionValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e VirtualInstructionValidationError) ErrorName() string {
	return "VirtualInstructionValidationError"
}

// Error satisfies the builtin error interface
func (e VirtualInstructionValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sVirtualInstruction.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = VirtualInstructionValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = VirtualInstructionValidationError{}
