...
// Validate checks the field values on FriendedUser with the rules defined in
// the proto definition for this message. If any rules are violated, an error
// is returned.
func (m *FriendedUser) Validate() error {
	if m == nil {
		return nil
	}

	if _, ok := _FriendedUser_Platform_InLookup[m.GetPlatform()]; !ok {
		return FriendedUserValidationError{
			field:  "Platform",
			reason: "value must be in list [1]",
		}
	}
...
// FriendedUserValidationError is the validation error returned by
// FriendedUser.Validate if the designated constraints aren't met.
type FriendedUserValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e FriendedUserValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e FriendedUserValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e FriendedUserValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e FriendedUserValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e FriendedUserValidationError) ErrorName() string { return "FriendedUserValidationError" }

// Error satisfies the builtin error interface
func (e FriendedUserValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = FriendedUserValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = FriendedUserValidationError{}

var _FriendedUser_Platform_InLookup = map[FriendedUser_Platform]struct{}{
	1: {},
}
