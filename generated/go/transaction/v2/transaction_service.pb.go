...
var file_transaction_v2_transaction_service_proto_rawDesc = []byte{
	...
	0x6f, 0x75, 0x6e, 0x74, 0x22, 0x86, 0x01, 0x0a, 0x09, 0x53, 0x65, 0x6e, 0x64, 0x4c, 0x69, 0x6d,
	...
	0x28, 0x02, 0x52, 0x09, 0x6d, 0x61, 0x78, 0x50, 0x65, 0x72, 0x44, 0x61, 0x79, 0x2a, 0x43, 0x0a,
	0x0b, 0x41, 0x69, 0x72, 0x64, 0x72, 0x6f, 0x70, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0b, 0x0a, 0x07,
	0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x00, 0x12, 0x14, 0x0a, 0x10, 0x4f, 0x4e, 0x42,
	0x4f, 0x41, 0x52, 0x44, 0x49, 0x4e, 0x47, 0x5f, 0x42, 0x4f, 0x4e, 0x55, 0x53, 0x10, 0x01, 0x12,
	0x11, 0x0a, 0x0d, 0x57, 0x45, 0x4c, 0x43, 0x4f, 0x4d, 0x45, 0x5f, 0x42, 0x4f, 0x4e, 0x55, 0x53,
	0x10, 0x02, 0x32, 0xfe, 0x04, 0x0a, 0x0b, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69,
	...
	0x69, 0x72, 0x64, 0x72, 0x6f, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x63,
...
var file_transaction_v2_transaction_service_proto_depIdxs = []int32{
	...
	53, // 81: code.transaction.v2.SubmitIntentRequest.SubmitActions.id:type_name -> code.common.v1.IntentId
	54, // 82: code.transaction.v2.SubmitIntentRequest.SubmitActions.owner:type_name -> code.common.v1.SolanaAccountId
	23, // 83: code.transaction.v2.SubmitIntentRequest.SubmitActions.metadata:type_name -> code.transaction.v2.Metadata
	28, // 84: code.transaction.v2.SubmitIntentRequest.SubmitActions.actions:type_name -> code.transaction.v2.Action
	55, // 85: code.transaction.v2.SubmitIntentRequest.SubmitActions.signature:type_name -> code.common.v1.Signature
	55, // 86: code.transaction.v2.SubmitIntentRequest.SubmitSignatures.signatures:type_name -> code.common.v1.Signature
	33, // 87: code.transaction.v2.SubmitIntentResponse.ServerParameters.server_parameters:type_name -> code.transaction.v2.ServerParameter
	...
	39, // 90: code.transaction.v2.SubmitIntentResponse.Error.error_details:type_name -> code.transaction.v2.ErrorDetails
	45, // 91: code.transaction.v2.GetLimitsResponse.SendLimitsByCurrencyEntry.value:type_name -> code.transaction.v2.SendLimit
	54, // 92: code.transaction.v2.PublicDistributionMetadata.Distribution.destination:type_name -> code.common.v1.SolanaAccountId
	11, // 93: code.transaction.v2.Transaction.SubmitIntent:input_type -> code.transaction.v2.SubmitIntentRequest
	13, // 94: code.transaction.v2.Transaction.GetIntentMetadata:input_type -> code.transaction.v2.GetIntentMetadataRequest
	15, // 95: code.transaction.v2.Transaction.GetLimits:input_type -> code.transaction.v2.GetLimitsRequest
	17, // 96: code.transaction.v2.Transaction.CanWithdrawToAccount:input_type -> code.transaction.v2.CanWithdrawToAccountRequest
	19, // 97: code.transaction.v2.Transaction.Airdrop:input_type -> code.transaction.v2.AirdropRequest
	21, // 98: code.transaction.v2.Transaction.VoidGiftCard:input_type -> code.transaction.v2.VoidGiftCardRequest
	12, // 99: code.transaction.v2.Transaction.SubmitIntent:output_type -> code.transaction.v2.SubmitIntentResponse
	14, // 100: code.transaction.v2.Transaction.GetIntentMetadata:output_type -> code.transaction.v2.GetIntentMetadataResponse
	16, // 101: code.transaction.v2.Transaction.GetLimits:output_type -> code.transaction.v2.GetLimitsResponse
	18, // 102: code.transaction.v2.Transaction.CanWithdrawToAccount:output_type -> code.transaction.v2.CanWithdrawToAccountResponse
	20, // 103: code.transaction.v2.Transaction.Airdrop:output_type -> code.transaction.v2.AirdropResponse
	22, // 104: code.transaction.v2.Transaction.VoidGiftCard:output_type -> code.transaction.v2.VoidGiftCardResponse
