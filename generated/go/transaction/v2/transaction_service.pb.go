...
var (
	StartSwapResponse_Success_Code_name = map[int32]string{
		0: "OK",
	}
	StartSwapResponse_Success_Code_value = map[string]int32{
		"OK": 0,
	}
)

func (x StartSwapResponse_Success_Code) Enum() *StartSwapResponse_Success_Code {
	p := new(StartSwapResponse_Success_Code)
	*p = x
	return p
}
...
const (
	// Denied by a guard (spam, money laundering, etc)
	StartSwapResponse_Error_DENIED StartSwapResponse_Error_Code = 0
	// There is an issue with the provided signature
	StartSwapResponse_Error_SIGNATURE_ERROR StartSwapResponse_Error_Code = 1
	// The swap metadata failed server-side validation
	StartSwapResponse_Error_INVALID_SWAP StartSwapResponse_Error_Code = 2
)

// Enum value maps for StartSwapResponse_Error_Code.
var (
	StartSwapResponse_Error_Code_name = map[int32]string{
		0: "DENIED",
		1: "SIGNATURE_ERROR",
		2: "INVALID_SWAP",
	}
	StartSwapResponse_Error_Code_value = map[string]int32{
		"DENIED":          0,
		"SIGNATURE_ERROR": 1,
		"INVALID_SWAP":    2,
	}
...
func (x StartSwapResponse_Error_Code) Enum() *StartSwapResponse_Error_Code {
	p := new(StartSwapResponse_Error_Code)
	*p = x
	return p
}
...
const (
	...
	// There is an issue with the provided signature.
	SwapResponse_Error_SIGNATURE_ERROR SwapResponse_Error_Code = 1
	// The swap failed server-side validation
	SwapResponse_Error_INVALID_SWAP SwapResponse_Error_Code = 2
	// The submitted swap transaction failed. Attempt the swap again.
	SwapResponse_Error_SWAP_FAILED SwapResponse_Error_Code = 3
)
...
const (
	...
	SwapMetadata_FUNDED     SwapMetadata_State = 2 // The VM swap PDA has been funded
	SwapMetadata_SUBMITTING SwapMetadata_State = 3 // The swap transaction is being submitted to the blockchain
	SwapMetadata_FINALIZED  SwapMetadata_State = 4 // The swap transaction has been finalized on the blockchain
	SwapMetadata_FAILED     SwapMetadata_State = 5 // The swap transaction failed
	SwapMetadata_CANCELLING SwapMetadata_State = 6 // The swap is in the process of being cancelled.
	SwapMetadata_CANCELLED  SwapMetadata_State = 7 // The swap transaction is cancelled. Funds have been deposited back into the VM
)
...
func (x *StartSwapRequest) GetStart() *StartSwapRequest_Start {
	if x, ok := x.GetRequest().(*StartSwapRequest_Start_); ok {
		return x.Start
	}
	return nil
}
...
func (x *StartSwapRequest) GetSubmitSignature() *StartSwapRequest_SubmitSignature {
	if x, ok := x.GetRequest().(*StartSwapRequest_SubmitSignature_); ok {
		return x.SubmitSignature
	}
	return nil
}

type isStartSwapRequest_Request interface {
	isStartSwapRequest_Request()
}
...
func (*StartSwapRequest_Start_) isStartSwapRequest_Request() {}

func (*StartSwapRequest_SubmitSignature_) isStartSwapRequest_Request() {}
...
func (x *StartSwapResponse) GetServerParameters() *StartSwapResponse_ServerParameters {
	if x, ok := x.GetResponse().(*StartSwapResponse_ServerParameters_); ok {
		return x.ServerParameters
	}
	return nil
}
...
func (x *StartSwapResponse) GetSuccess() *StartSwapResponse_Success {
	if x, ok := x.GetResponse().(*StartSwapResponse_Success_); ok {
		return x.Success
	}
	return nil
}
...
func (x *StartSwapResponse) GetError() *StartSwapResponse_Error {
	if x, ok := x.GetResponse().(*StartSwapResponse_Error_); ok {
		return x.Error
	}
	return nil
}

type isStartSwapResponse_Response interface {
	isStartSwapResponse_Response()
}
...
func (*StartSwapResponse_ServerParameters_) isStartSwapResponse_Response() {}

func (*StartSwapResponse_Success_) isStartSwapResponse_Response() {}

func (*StartSwapResponse_Error_) isStartSwapResponse_Response() {}
...
type GetSwapResponse struct {
	...
	Result GetSwapResponse_Result `protobuf:"varint,1,opt,name=result,proto3,enum=code.transaction.v2.GetSwapResponse_Result" json:"result,omitempty"`
...
type GetPendingSwapsResponse struct {
	...
	Result GetPendingSwapsResponse_Result `protobuf:"varint,1,opt,name=result,proto3,enum=code.transaction.v2.GetPendingSwapsResponse_Result" json:"result,omitempty"`
...
func (x *SwapRequest) GetSubmitSignature() *SwapRequest_SubmitSignatures {
	if x, ok := x.GetRequest().(*SwapRequest_SubmitSignature); ok {
		return x.SubmitSignature
	}
	return nil
}
...
type SwapRequest_SubmitSignature struct {
	SubmitSignature *SwapRequest_SubmitSignatures `protobuf:"bytes,2,opt,name=submit_signature,json=submitSignature,proto3,oneof"`
}

func (*SwapRequest_Initiate_) isSwapRequest_Request() {}

func (*SwapRequest_SubmitSignature) isSwapRequest_Request() {}
...
type SendPublicPaymentMetadata struct {
	...
	// to a VM swap PDA
	SwapId *v1.SwapId `protobuf:"bytes,8,opt,name=swap_id,json=swapId,proto3" json:"swap_id,omitempty"`
}
...
func (x *SendPublicPaymentMetadata) GetSwapId() *v1.SwapId {
	if x != nil {
		return x.SwapId
	}
	return nil
...
type SwapMetadata struct {
	...
	State            SwapMetadata_State    `protobuf:"varint,2,opt,name=state,proto3,enum=code.transaction.v2.SwapMetadata_State" json:"state,omitempty"`
...
func (x *StartSwapRequest_Start) GetCurrencyCreator() *StartSwapRequest_Start_CurrencyCreator {
	if x, ok := x.GetKind().(*StartSwapRequest_Start_CurrencyCreator_); ok {
		return x.CurrencyCreator
	}
	return nil
}

type isStartSwapRequest_Start_Kind interface {
	isStartSwapRequest_Start_Kind()
}
...
func (*StartSwapRequest_Start_CurrencyCreator_) isStartSwapRequest_Start_Kind() {}
...
type StartSwapRequest_SubmitSignature struct {
	...
	Signatures *v1.Signature `protobuf:"bytes,1,opt,name=signatures,proto3" json:"signatures,omitempty"`
}
...
func (x *StartSwapRequest_SubmitSignature) GetSignatures() *v1.Signature {
	if x != nil {
		return x.Signatures
	}
	return nil
...
type StartSwapRequest_Start_CurrencyCreator struct {
	...
	FundingSource FundingSource `protobuf:"varint,5,opt,name=funding_source,json=fundingSource,proto3,enum=code.transaction.v2.FundingSource" json:"funding_source,omitempty"`
...
func (x *StartSwapResponse_ServerParameters) GetCurrencyCreator() *StartSwapResponse_ServerParameters_CurrencyCreator {
	if x, ok := x.GetKind().(*StartSwapResponse_ServerParameters_CurrencyCreator_); ok {
		return x.CurrencyCreator
	}
	return nil
}

type isStartSwapResponse_ServerParameters_Kind interface {
	isStartSwapResponse_ServerParameters_Kind()
}
...
func (*StartSwapResponse_ServerParameters_CurrencyCreator_) isStartSwapResponse_ServerParameters_Kind() {
}
...
type StartSwapResponse_Success struct {
	...
	Code StartSwapResponse_Success_Code `protobuf:"varint,1,opt,name=code,proto3,enum=code.transaction.v2.StartSwapResponse_Success_Code" json:"code,omitempty"`
}
...
func (x *StartSwapResponse_Success) GetCode() StartSwapResponse_Success_Code {
	...
	return StartSwapResponse_Success_OK
}
...
type StartSwapResponse_Error struct {
	...
	Code         StartSwapResponse_Error_Code `protobuf:"varint,1,opt,name=code,proto3,enum=code.transaction.v2.StartSwapResponse_Error_Code" json:"code,omitempty"`
	ErrorDetails []*ErrorDetails              `protobuf:"bytes,2,rep,name=error_details,json=errorDetails,proto3" json:"error_details,omitempty"`
}
...
func (x *StartSwapResponse_Error) GetCode() StartSwapResponse_Error_Code {
	...
	return StartSwapResponse_Error_DENIED
}
...
func (x *SwapRequest_Initiate) GetStateless() *SwapRequest_Initiate_Stateless {
	if x, ok := x.GetKind().(*SwapRequest_Initiate_Stateless_); ok {
		return x.Stateless
	}
	return nil
}
...
func (x *SwapRequest_Initiate) GetStateful() *SwapRequest_Initiate_Stateful {
	if x, ok := x.GetKind().(*SwapRequest_Initiate_Stateful_); ok {
		return x.Stateful
	}
	return nil
}

type isSwapRequest_Initiate_Kind interface {
	isSwapRequest_Initiate_Kind()
}
...
func (*SwapRequest_Initiate_Stateless_) isSwapRequest_Initiate_Kind() {}

func (*SwapRequest_Initiate_Stateful_) isSwapRequest_Initiate_Kind() {}
...
type SwapRequest_Initiate_Stateless struct {
	...
	WaitForBlockchainStatus bool `protobuf:"varint,6,opt,name=wait_for_blockchain_status,json=waitForBlockchainStatus,proto3" json:"wait_for_blockchain_status,omitempty"`
...
func (x *SwapResponse_ServerParameters) GetCurrencyCreatorStateless() *SwapResponse_ServerParameters_CurrencyCreatorStateless {
	if x, ok := x.GetKind().(*SwapResponse_ServerParameters_CurrencyCreatorStateless_); ok {
		return x.CurrencyCreatorStateless
	}
	return nil
}

func (x *SwapResponse_ServerParameters) GetCurrencyCreatorStateful() *SwapResponse_ServerParameters_CurrencyCreatorStateful {
	if x, ok := x.GetKind().(*SwapResponse_ServerParameters_CurrencyCreatorStateful_); ok {
		return x.CurrencyCreatorStateful
	}
	return nil
}

type isSwapResponse_ServerParameters_Kind interface {
	isSwapResponse_ServerParameters_Kind()
}
...
func (*SwapResponse_ServerParameters_CurrencyCreatorStateless_) isSwapResponse_ServerParameters_Kind() {
}

func (*SwapResponse_ServerParameters_CurrencyCreatorStateful_) isSwapResponse_ServerParameters_Kind() {
}
...
var file_transaction_v2_transaction_service_proto_rawDesc = []byte{
	...
	,
	...
	0x52, 0x08, 0x66, 0x72, 0x6f, 0x6d, 0x4d, 0x69, 0x6e, 0x74, 0x12, 0x44, 0x0a, 0x07, 0x74, 0x6f,
	0x5f, 0x6d, 0x69, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x63, 0x6f,
	0x64, 0x65, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x6f, 0x6c,
	0x61, 0x6e, 0x61, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x64, 0x42, 0x0a, 0xba, 0xe9,
	0xc0, 0x03, 0x05, 0x8a, 0x01, 0x02, 0x10, 0x01, 0x52, 0x06, 0x74, 0x6f, 0x4d, 0x69, 0x6e, 0x74,
	...
	,
	...
	0x4a, 0x0a, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
	...
	0x48, 0x00, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x12, 0x44, 0x0a, 0x05, 0x65,
	0x72, 0x72, 0x6f, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2c, 0x2e, 0x63, 0x6f, 0x64,
	0x65, 0x2e, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x76, 0x32,
	...
	0x72, 0x1a, 0xb3, 0x02, 0x0a, 0x10, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x50, 0x61, 0x72, 0x61,
	0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x12, 0x74, 0x0a, 0x10, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e,
	0x63, 0x79, 0x5f, 0x63, 0x72, 0x65, 0x61, 0x74, 0x6f, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x47, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x2e, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x2e, 0x76, 0x32, 0x2e, 0x53, 0x74, 0x61, 0x72, 0x74, 0x53, 0x77, 0x61, 0x70,
	...
	0x63, 0x79, 0x43, 0x72, 0x65, 0x61, 0x74, 0x6f, 0x72, 0x48, 0x00, 0x52, 0x0f, 0x63, 0x75, 0x72,
	0x72, 0x65, 0x6e, 0x63, 0x79, 0x43, 0x72, 0x65, 0x61, 0x74, 0x6f, 0x72, 0x1a, 0x99, 0x01, 0x0a,
	0x0f, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x43, 0x72, 0x65, 0x61, 0x74, 0x6f, 0x72,
	0x12, 0x41, 0x0a, 0x05, 0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x42, 0x0a, 0xba, 0xe9, 0xc0, 0x03, 0x05, 0x8a, 0x01, 0x02, 0x10, 0x01, 0x52, 0x05, 0x6e, 0x6f,
	0x6e, 0x63, 0x65, 0x12, 0x43, 0x0a, 0x09, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x68, 0x61, 0x73, 0x68,
	...
	0x68, 0x42, 0x0a, 0xba, 0xe9, 0xc0, 0x03, 0x05, 0x8a, 0x01, 0x02, 0x10, 0x01, 0x52, 0x09, 0x62,
	0x6c, 0x6f, 0x63, 0x6b, 0x68, 0x61, 0x73, 0x68, 0x42, 0x0d, 0x0a, 0x04, 0x6b, 0x69, 0x6e, 0x64,
	0x12, 0x05, 0xb8, 0xe9, 0xc0, 0x03, 0x01, 0x1a, 0x62, 0x0a, 0x07, 0x53, 0x75, 0x63, 0x63, 0x65,
	0x73, 0x73, 0x12, 0x47, 0x0a, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e,
	...
	,
	...
	0x41, 0x54, 0x55, 0x52, 0x45, 0x5f, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x01, 0x12, 0x10, 0x0a,
	0x0c, 0x49, 0x4e, 0x56, 0x41, 0x4c, 0x49, 0x44, 0x5f, 0x53, 0x57, 0x41, 0x50, 0x10, 0x02, 0x42,
	0x11, 0x0a, 0x08, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x05, 0xb8, 0xe9, 0xc0,
	0x03, 0x01, 0x22, 0xcc, 0x01, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x53, 0x77, 0x61, 0x70, 0x52, 0x65,
	...
	0x76, 0x31, 0x2e, 0x53, 0x77, 0x61, 0x70, 0x49, 0x64, 0x42, 0x0a, 0xba, 0xe9, 0xc0, 0x03, 0x05,
	0x8a, 0x01, 0x02, 0x10, 0x01, 0x52, 0x02, 0x69, 0x64, 0x12, 0x41, 0x0a, 0x05, 0x6f, 0x77, 0x6e,
	...
	,
	...
	0x2e, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x42, 0x0a, 0xba, 0xe9, 0xc0, 0x03,
	0x05, 0x8a, 0x01, 0x02, 0x10, 0x01, 0x52, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72,
	0x65, 0x22, 0xcd, 0x01, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x50, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67,
	0x53, 0x77, 0x61, 0x70, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4b, 0x0a,
	...
	,
	...
	0x52, 0x08, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x74, 0x65, 0x12, 0x5e, 0x0a, 0x10, 0x73, 0x75,
	0x62, 0x6d, 0x69, 0x74, 0x5f, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x18, 0x02,
	...
	,
	...
	0x2e, 0x49, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x74, 0x65, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x66,
	0x75, 0x6c, 0x48, 0x00, 0x52, 0x08, 0x73, 0x74, 0x61, 0x74, 0x65, 0x66, 0x75, 0x6c, 0x1a, 0xd7,
	0x03, 0x0a, 0x09, 0x53, 0x74, 0x61, 0x74, 0x65, 0x6c, 0x65, 0x73, 0x73, 0x12, 0x41, 0x0a, 0x05,
	...
	0x48, 0x0a, 0x09, 0x66, 0x72, 0x6f, 0x6d, 0x5f, 0x6d, 0x69, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01,
	...
	0x08, 0x66, 0x72, 0x6f, 0x6d, 0x4d, 0x69, 0x6e, 0x74, 0x12, 0x44, 0x0a, 0x07, 0x74, 0x6f, 0x5f,
	0x6d, 0x69, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x63, 0x6f, 0x64,
	0x65, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x6f, 0x6c, 0x61,
	0x6e, 0x61, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x64, 0x42, 0x0a, 0xba, 0xe9, 0xc0,
	0x03, 0x05, 0x8a, 0x01, 0x02, 0x10, 0x01, 0x52, 0x06, 0x74, 0x6f, 0x4d, 0x69, 0x6e, 0x74, 0x12,
	...
	,
	...
	0x74, 0x68, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e,
	0x63, 0x6f, 0x64, 0x65, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x2e, 0x53,
	0x6f, 0x6c, 0x61, 0x6e, 0x61, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x64, 0x42, 0x0a,
	0xba, 0xe9, 0xc0, 0x03, 0x05, 0x8a, 0x01, 0x02, 0x10, 0x01, 0x52, 0x0d, 0x73, 0x77, 0x61, 0x70,
	0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x12, 0x43, 0x0a, 0x09, 0x73, 0x69, 0x67,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x5f, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x01, 0x12, 0x10, 0x0a, 0x0c, 0x49, 0x4e, 0x56, 0x41,
	0x4c, 0x49, 0x44, 0x5f, 0x53, 0x57, 0x41, 0x50, 0x10, 0x02, 0x12, 0x0f, 0x0a, 0x0b, 0x53, 0x57,
	0x41, 0x50, 0x5f, 0x46, 0x41, 0x49, 0x4c, 0x45, 0x44, 0x10, 0x03, 0x42, 0x11, 0x0a, 0x08, 0x72,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x05, 0xb8, 0xe9, 0xc0, 0x03, 0x01, 0x22, 0xc3,
	0x03, 0x0a, 0x08, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x50, 0x0a, 0x0d, 0x6f,
	...
	0x0c, 0x6f, 0x70, 0x65, 0x6e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x12, 0x60, 0x0a,
	...
	0x63, 0x6c, 0x79, 0x12, 0x62, 0x0a, 0x13, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x5f, 0x64, 0x69,
	...
	,
	...
	0x04, 0x50, 0x4f, 0x4f, 0x4c, 0x10, 0x01, 0x22, 0x82, 0x04, 0x0a, 0x19, 0x53, 0x65, 0x6e, 0x64,
	...
	0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x4c, 0x0a, 0x11, 0x64, 0x65, 0x73,
	0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x18, 0x06,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x2e, 0x63, 0x6f, 0x6d, 0x6d,
	0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x6f, 0x6c, 0x61, 0x6e, 0x61, 0x41, 0x63, 0x63, 0x6f,
	0x75, 0x6e, 0x74, 0x49, 0x64, 0x52, 0x10, 0x64, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x4f, 0x77, 0x6e, 0x65, 0x72, 0x12, 0x52, 0x0a, 0x0d, 0x65, 0x78, 0x63, 0x68, 0x61,
	...
	,
	...
	0x65, 0x6d, 0x6f, 0x74, 0x65, 0x53, 0x65, 0x6e, 0x64, 0x12, 0x46, 0x0a, 0x0d, 0x65, 0x78, 0x63,
	0x68, 0x61, 0x6e, 0x67, 0x65, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b,
	...
	0x61, 0x12, 0x33, 0x0a, 0x04, 0x6d, 0x69, 0x6e, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x1f, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x76, 0x31,
	0x2e, 0x53, 0x6f, 0x6c, 0x61, 0x6e, 0x61, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x64,
	0x52, 0x04, 0x6d, 0x69, 0x6e, 0x74, 0x4a, 0x04, 0x08, 0x04, 0x10, 0x05, 0x22, 0x89, 0x03, 0x0a,
	0x1a, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x44, 0x69, 0x73, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74,
	0x69, 0x6f, 0x6e, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x43, 0x0a, 0x06, 0x73,
	...
	,
	...
	,
	...
	0x70, 0x65, 0x12, 0x05, 0xb8, 0xe9, 0xc0, 0x03, 0x01, 0x4a, 0x04, 0x08, 0x03, 0x10, 0x04, 0x4a,
	0x04, 0x08, 0x04, 0x10, 0x05, 0x4a, 0x04, 0x08, 0x07, 0x10, 0x08, 0x4a, 0x04, 0x08, 0x08, 0x10,
	0x09, 0x4a, 0x04, 0x08, 0x09, 0x10, 0x0a, 0x22, 0xd3, 0x03, 0x0a, 0x11, 0x4f, 0x70, 0x65, 0x6e,
	...
	0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x33, 0x0a, 0x04, 0x6d, 0x69, 0x6e, 0x74,
	0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x2e, 0x63, 0x6f,
	0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x6f, 0x6c, 0x61, 0x6e, 0x61, 0x41, 0x63,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x64, 0x52, 0x04, 0x6d, 0x69, 0x6e, 0x74, 0x22, 0xd0, 0x02,
	0x0a, 0x17, 0x4e, 0x6f, 0x50, 0x72, 0x69, 0x76, 0x61, 0x63, 0x79, 0x54, 0x72, 0x61, 0x6e, 0x73,
	0x66, 0x65, 0x72, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x49, 0x0a, 0x09, 0x61, 0x75, 0x74,
	...
	0x02, 0x20, 0x00, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x33, 0x0a, 0x04, 0x6d,
	0x69, 0x6e, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x63, 0x6f, 0x64, 0x65,
	0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x6f, 0x6c, 0x61, 0x6e,
	0x61, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x64, 0x52, 0x04, 0x6d, 0x69, 0x6e, 0x74,
	0x22, 0xa4, 0x03, 0x0a, 0x17, 0x4e, 0x6f, 0x50, 0x72, 0x69, 0x76, 0x61, 0x63, 0x79, 0x57, 0x69,
	0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x49, 0x0a, 0x09,
	...
	0x03, 0x04, 0x32, 0x02, 0x20, 0x00, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x2c,
	...
	,
	...
	,
	...
	0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x12, 0x51, 0x0a, 0x0b, 0x66, 0x65, 0x65, 0x5f, 0x70,
	...
	0x66, 0x65, 0x65, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x42, 0x0d, 0x0a, 0x04, 0x74, 0x79,
	0x70, 0x65, 0x12, 0x05, 0xb8, 0xe9, 0xc0, 0x03, 0x01, 0x4a, 0x04, 0x08, 0x04, 0x10, 0x05, 0x4a,
	0x04, 0x08, 0x05, 0x10, 0x06, 0x4a, 0x04, 0x08, 0x08, 0x10, 0x09, 0x4a, 0x04, 0x08, 0x09, 0x10,
	0x0a, 0x4a, 0x04, 0x08, 0x0a, 0x10, 0x0b, 0x22, 0xa3, 0x01, 0x0a, 0x19, 0x4e, 0x6f, 0x6e, 0x63,
	...
	0x74, 0x65, 0x72, 0x22, 0x6a, 0x0a, 0x19, 0x46, 0x65, 0x65, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e,
	...
	0x98, 0x02, 0x0a, 0x0c, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73,
	0x12, 0x54, 0x0a, 0x0d, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x5f, 0x73, 0x74, 0x72, 0x69, 0x6e,
	0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2d, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x2e, 0x74,
	...
	,
	...
	,
	...
	0x22, 0x95, 0x01, 0x0a, 0x12, 0x44, 0x65, 0x6e, 0x69, 0x65, 0x64, 0x45, 0x72, 0x72, 0x6f, 0x72,
	0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x12, 0x40, 0x0a, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x18,
	...
	,
	...
	,
	...
	,
	...
	0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0x77, 0x0a, 0x05, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12,
	0x0b, 0x0a, 0x07, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x07,
	0x43, 0x52, 0x45, 0x41, 0x54, 0x45, 0x44, 0x10, 0x01, 0x12, 0x0a, 0x0a, 0x06, 0x46, 0x55, 0x4e,
	0x44, 0x45, 0x44, 0x10, 0x02, 0x12, 0x0e, 0x0a, 0x0a, 0x53, 0x55, 0x42, 0x4d, 0x49, 0x54, 0x54,
	0x49, 0x4e, 0x47, 0x10, 0x03, 0x12, 0x0d, 0x0a, 0x09, 0x46, 0x49, 0x4e, 0x41, 0x4c, 0x49, 0x5a,
	...
	,
	...
	0x6d, 0x69, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x7b, 0x0a, 0x14,
	0x43, 0x61, 0x6e, 0x57, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x54, 0x6f, 0x41, 0x63, 0x63,
	0x6f, 0x75, 0x6e, 0x74, 0x12, 0x30, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x2e, 0x74, 0x72, 0x61, 0x6e,
	...
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x31, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x2e, 0x74, 0x72,
	...
	,
...
var file_transaction_v2_transaction_service_proto_goTypes = []interface{}{
	...
	(FundingSource)(0),                                             // 1: code.transaction.v2.FundingSource
	(SubmitIntentResponse_Success_Code)(0),                         // 2: code.transaction.v2.SubmitIntentResponse.Success.Code
	(SubmitIntentResponse_Error_Code)(0),                           // 3: code.transaction.v2.SubmitIntentResponse.Error.Code
	(GetIntentMetadataResponse_Result)(0),                          // 4: code.transaction.v2.GetIntentMetadataResponse.Result
	(GetLimitsResponse_Result)(0),                                  // 5: code.transaction.v2.GetLimitsResponse.Result
	(CanWithdrawToAccountResponse_AccountType)(0),                  // 6: code.transaction.v2.CanWithdrawToAccountResponse.AccountType
	(AirdropResponse_Result)(0),                                    // 7: code.transaction.v2.AirdropResponse.Result
	(VoidGiftCardResponse_Result)(0),                               // 8: code.transaction.v2.VoidGiftCardResponse.Result
	(StartSwapResponse_Success_Code)(0),                            // 9: code.transaction.v2.StartSwapResponse.Success.Code
	(StartSwapResponse_Error_Code)(0),                              // 10: code.transaction.v2.StartSwapResponse.Error.Code
	(GetSwapResponse_Result)(0),                                    // 11: code.transaction.v2.GetSwapResponse.Result
	(GetPendingSwapsResponse_Result)(0),                            // 12: code.transaction.v2.GetPendingSwapsResponse.Result
	(SwapResponse_Success_Code)(0),                                 // 13: code.transaction.v2.SwapResponse.Success.Code
	(SwapResponse_Error_Code)(0),                                   // 14: code.transaction.v2.SwapResponse.Error.Code
	(OpenAccountsMetadata_AccountSet)(0),                           // 15: code.transaction.v2.OpenAccountsMetadata.AccountSet
	(FeePaymentAction_FeeType)(0),                                  // 16: code.transaction.v2.FeePaymentAction.FeeType
	(DeniedErrorDetails_Code)(0),                                   // 17: code.transaction.v2.DeniedErrorDetails.Code
	(SwapMetadata_State)(0),                                        // 18: code.transaction.v2.SwapMetadata.State
	...
	(*CanWithdrawToAccountRequest)(nil),                            // 25: code.transaction.v2.CanWithdrawToAccountRequest
	(*CanWithdrawToAccountResponse)(nil),                           // 26: code.transaction.v2.CanWithdrawToAccountResponse
	(*AirdropRequest)(nil),                                         // 27: code.transaction.v2.AirdropRequest
	(*AirdropResponse)(nil),                                        // 28: code.transaction.v2.AirdropResponse
	(*VoidGiftCardRequest)(nil),                                    // 29: code.transaction.v2.VoidGiftCardRequest
	(*VoidGiftCardResponse)(nil),                                   // 30: code.transaction.v2.VoidGiftCardResponse
	(*StartSwapRequest)(nil),                                       // 31: code.transaction.v2.StartSwapRequest
	(*StartSwapResponse)(nil),                                      // 32: code.transaction.v2.StartSwapResponse
	(*GetSwapRequest)(nil),                                         // 33: code.transaction.v2.GetSwapRequest
	(*GetSwapResponse)(nil),                                        // 34: code.transaction.v2.GetSwapResponse
	(*GetPendingSwapsRequest)(nil),                                 // 35: code.transaction.v2.GetPendingSwapsRequest
	(*GetPendingSwapsResponse)(nil),                                // 36: code.transaction.v2.GetPendingSwapsResponse
	(*SwapRequest)(nil),                                            // 37: code.transaction.v2.SwapRequest
	(*SwapResponse)(nil),                                           // 38: code.transaction.v2.SwapResponse
	(*Metadata)(nil),                                               // 39: code.transaction.v2.Metadata
	(*OpenAccountsMetadata)(nil),                                   // 40: code.transaction.v2.OpenAccountsMetadata
	(*SendPublicPaymentMetadata)(nil),                              // 41: code.transaction.v2.SendPublicPaymentMetadata
	(*ReceivePaymentsPubliclyMetadata)(nil),                        // 42: code.transaction.v2.ReceivePaymentsPubliclyMetadata
	(*PublicDistributionMetadata)(nil),                             // 43: code.transaction.v2.PublicDistributionMetadata
	(*Action)(nil),                                                 // 44: code.transaction.v2.Action
	(*OpenAccountAction)(nil),                                      // 45: code.transaction.v2.OpenAccountAction
	...
	(*FeePaymentAction)(nil),                                       // 48: code.transaction.v2.FeePaymentAction
	(*ServerParameter)(nil),                                        // 49: code.transaction.v2.ServerParameter
	(*NoncedTransactionMetadata)(nil),                              // 50: code.transaction.v2.NoncedTransactionMetadata
	(*OpenAccountServerParameter)(nil),                             // 51: code.transaction.v2.OpenAccountServerParameter
	(*NoPrivacyTransferServerParameter)(nil),                       // 52: code.transaction.v2.NoPrivacyTransferServerParameter
	(*NoPrivacyWithdrawServerParameter)(nil),                       // 53: code.transaction.v2.NoPrivacyWithdrawServerParameter
	(*FeePaymentServerParameter)(nil),                              // 54: code.transaction.v2.FeePaymentServerParameter
	(*ErrorDetails)(nil),                                           // 55: code.transaction.v2.ErrorDetails
	(*ReasonStringErrorDetails)(nil),                               // 56: code.transaction.v2.ReasonStringErrorDetails
	(*InvalidSignatureErrorDetails)(nil),                           // 57: code.transaction.v2.InvalidSignatureErrorDetails
	(*DeniedErrorDetails)(nil),                                     // 58: code.transaction.v2.DeniedErrorDetails
	(*ExchangeData)(nil),                                           // 59: code.transaction.v2.ExchangeData
	(*ExchangeDataWithoutRate)(nil),                                // 60: code.transaction.v2.ExchangeDataWithoutRate
	(*SendLimit)(nil),                                              // 61: code.transaction.v2.SendLimit
	(*VerifiedSwapMetadata)(nil),                                   // 62: code.transaction.v2.VerifiedSwapMetadata
	(*VerifiedCurrencyCreatorSwapMetadata)(nil),                    // 63: code.transaction.v2.VerifiedCurrencyCreatorSwapMetadata
	(*SwapMetadata)(nil),                                           // 64: code.transaction.v2.SwapMetadata
	(*SubmitIntentRequest_SubmitActions)(nil),                      // 65: code.transaction.v2.SubmitIntentRequest.SubmitActions
	(*SubmitIntentRequest_SubmitSignatures)(nil),                   // 66: code.transaction.v2.SubmitIntentRequest.SubmitSignatures
	(*SubmitIntentResponse_ServerParameters)(nil),                  // 67: code.transaction.v2.SubmitIntentResponse.ServerParameters
	(*SubmitIntentResponse_Success)(nil),                           // 68: code.transaction.v2.SubmitIntentResponse.Success
	(*SubmitIntentResponse_Error)(nil),                             // 69: code.transaction.v2.SubmitIntentResponse.Error
	nil,                                                            // 70: code.transaction.v2.GetLimitsResponse.SendLimitsByCurrencyEntry
	(*StartSwapRequest_Start)(nil),                                 // 71: code.transaction.v2.StartSwapRequest.Start
	(*StartSwapRequest_SubmitSignature)(nil),                       // 72: code.transaction.v2.StartSwapRequest.SubmitSignature
	(*StartSwapRequest_Start_CurrencyCreator)(nil),                 // 73: code.transaction.v2.StartSwapRequest.Start.CurrencyCreator
	(*StartSwapResponse_ServerParameters)(nil),                     // 74: code.transaction.v2.StartSwapResponse.ServerParameters
	(*StartSwapResponse_Success)(nil),                              // 75: code.transaction.v2.StartSwapResponse.Success
	(*StartSwapResponse_Error)(nil),                                // 76: code.transaction.v2.StartSwapResponse.Error
	(*StartSwapResponse_ServerParameters_CurrencyCreator)(nil),     // 77: code.transaction.v2.StartSwapResponse.ServerParameters.CurrencyCreator
	(*SwapRequest_Initiate)(nil),                                   // 78: code.transaction.v2.SwapRequest.Initiate
	(*SwapRequest_SubmitSignatures)(nil),                           // 79: code.transaction.v2.SwapRequest.SubmitSignatures
	(*SwapRequest_Initiate_Stateless)(nil),                         // 80: code.transaction.v2.SwapRequest.Initiate.Stateless
	(*SwapRequest_Initiate_Stateful)(nil),                          // 81: code.transaction.v2.SwapRequest.Initiate.Stateful
	(*SwapResponse_ServerParameters)(nil),                          // 82: code.transaction.v2.SwapResponse.ServerParameters
	(*SwapResponse_Success)(nil),                                   // 83: code.transaction.v2.SwapResponse.Success
	(*SwapResponse_Error)(nil),                                     // 84: code.transaction.v2.SwapResponse.Error
	(*SwapResponse_ServerParameters_CurrencyCreatorStateless)(nil), // 85: code.transaction.v2.SwapResponse.ServerParameters.CurrencyCreatorStateless
	(*SwapResponse_ServerParameters_CurrencyCreatorStateful)(nil),  // 86: code.transaction.v2.SwapResponse.ServerParameters.CurrencyCreatorStateful
	(*PublicDistributionMetadata_Distribution)(nil),                // 87: code.transaction.v2.PublicDistributionMetadata.Distribution
	...
	(*v1.SwapId)(nil),                                              // 92: code.common.v1.SwapId
	...
	(*v1.SolanaAddressLookupTable)(nil),                            // 97: code.common.v1.SolanaAddressLookupTable
}
var file_transaction_v2_transaction_service_proto_depIdxs = []int32{
	65,  // 0: code.transaction.v2.SubmitIntentRequest.submit_actions:type_name -> code.transaction.v2.SubmitIntentRequest.SubmitActions
	66,  // 1: code.transaction.v2.SubmitIntentRequest.submit_signatures:type_name -> code.transaction.v2.SubmitIntentRequest.SubmitSignatures
	67,  // 2: code.transaction.v2.SubmitIntentResponse.server_parameters:type_name -> code.transaction.v2.SubmitIntentResponse.ServerParameters
	68,  // 3: code.transaction.v2.SubmitIntentResponse.success:type_name -> code.transaction.v2.SubmitIntentResponse.Success
	69,  // 4: code.transaction.v2.SubmitIntentResponse.error:type_name -> code.transaction.v2.SubmitIntentResponse.Error
	...
	4,   // 8: code.transaction.v2.GetIntentMetadataResponse.result:type_name -> code.transaction.v2.GetIntentMetadataResponse.Result
	39,  // 9: code.transaction.v2.GetIntentMetadataResponse.metadata:type_name -> code.transaction.v2.Metadata
	89,  // 10: code.transaction.v2.GetLimitsRequest.owner:type_name -> code.common.v1.SolanaAccountId
	90,  // 11: code.transaction.v2.GetLimitsRequest.signature:type_name -> code.common.v1.Signature
	91,  // 12: code.transaction.v2.GetLimitsRequest.consumed_since:type_name -> google.protobuf.Timestamp
	5,   // 13: code.transaction.v2.GetLimitsResponse.result:type_name -> code.transaction.v2.GetLimitsResponse.Result
	70,  // 14: code.transaction.v2.GetLimitsResponse.send_limits_by_currency:type_name -> code.transaction.v2.GetLimitsResponse.SendLimitsByCurrencyEntry
	89,  // 15: code.transaction.v2.CanWithdrawToAccountRequest.account:type_name -> code.common.v1.SolanaAccountId
	89,  // 16: code.transaction.v2.CanWithdrawToAccountRequest.mint:type_name -> code.common.v1.SolanaAccountId
	6,   // 17: code.transaction.v2.CanWithdrawToAccountResponse.account_type:type_name -> code.transaction.v2.CanWithdrawToAccountResponse.AccountType
	60,  // 18: code.transaction.v2.CanWithdrawToAccountResponse.fee_amount:type_name -> code.transaction.v2.ExchangeDataWithoutRate
	0,   // 19: code.transaction.v2.AirdropRequest.airdrop_type:type_name -> code.transaction.v2.AirdropType
	89,  // 20: code.transaction.v2.AirdropRequest.owner:type_name -> code.common.v1.SolanaAccountId
	90,  // 21: code.transaction.v2.AirdropRequest.signature:type_name -> code.common.v1.Signature
	7,   // 22: code.transaction.v2.AirdropResponse.result:type_name -> code.transaction.v2.AirdropResponse.Result
	59,  // 23: code.transaction.v2.AirdropResponse.exchange_data:type_name -> code.transaction.v2.ExchangeData
	89,  // 24: code.transaction.v2.VoidGiftCardRequest.owner:type_name -> code.common.v1.SolanaAccountId
	89,  // 25: code.transaction.v2.VoidGiftCardRequest.gift_card_vault:type_name -> code.common.v1.SolanaAccountId
	90,  // 26: code.transaction.v2.VoidGiftCardRequest.signature:type_name -> code.common.v1.Signature
	8,   // 27: code.transaction.v2.VoidGiftCardResponse.result:type_name -> code.transaction.v2.VoidGiftCardResponse.Result
	71,  // 28: code.transaction.v2.StartSwapRequest.start:type_name -> code.transaction.v2.StartSwapRequest.Start
	72,  // 29: code.transaction.v2.StartSwapRequest.submit_signature:type_name -> code.transaction.v2.StartSwapRequest.SubmitSignature
	74,  // 30: code.transaction.v2.StartSwapResponse.server_parameters:type_name -> code.transaction.v2.StartSwapResponse.ServerParameters
	75,  // 31: code.transaction.v2.StartSwapResponse.success:type_name -> code.transaction.v2.StartSwapResponse.Success
	76,  // 32: code.transaction.v2.StartSwapResponse.error:type_name -> code.transaction.v2.StartSwapResponse.Error
	92,  // 33: code.transaction.v2.GetSwapRequest.id:type_name -> code.common.v1.SwapId
	89,  // 34: code.transaction.v2.GetSwapRequest.owner:type_name -> code.common.v1.SolanaAccountId
	90,  // 35: code.transaction.v2.GetSwapRequest.signature:type_name -> code.common.v1.Signature
	11,  // 36: code.transaction.v2.GetSwapResponse.result:type_name -> code.transaction.v2.GetSwapResponse.Result
	64,  // 37: code.transaction.v2.GetSwapResponse.swap:type_name -> code.transaction.v2.SwapMetadata
	89,  // 38: code.transaction.v2.GetPendingSwapsRequest.owner:type_name -> code.common.v1.SolanaAccountId
	90,  // 39: code.transaction.v2.GetPendingSwapsRequest.signature:type_name -> code.common.v1.Signature
	12,  // 40: code.transaction.v2.GetPendingSwapsResponse.result:type_name -> code.transaction.v2.GetPendingSwapsResponse.Result
	64,  // 41: code.transaction.v2.GetPendingSwapsResponse.swaps:type_name -> code.transaction.v2.SwapMetadata
	78,  // 42: code.transaction.v2.SwapRequest.initiate:type_name -> code.transaction.v2.SwapRequest.Initiate
	79,  // 43: code.transaction.v2.SwapRequest.submit_signature:type_name -> code.transaction.v2.SwapRequest.SubmitSignatures
	82,  // 44: code.transaction.v2.SwapResponse.server_parameters:type_name -> code.transaction.v2.SwapResponse.ServerParameters
	83,  // 45: code.transaction.v2.SwapResponse.success:type_name -> code.transaction.v2.SwapResponse.Success
	84,  // 46: code.transaction.v2.SwapResponse.error:type_name -> code.transaction.v2.SwapResponse.Error
	40,  // 47: code.transaction.v2.Metadata.open_accounts:type_name -> code.transaction.v2.OpenAccountsMetadata
	41,  // 48: code.transaction.v2.Metadata.send_public_payment:type_name -> code.transaction.v2.SendPublicPaymentMetadata
	42,  // 49: code.transaction.v2.Metadata.receive_payments_publicly:type_name -> code.transaction.v2.ReceivePaymentsPubliclyMetadata
	43,  // 50: code.transaction.v2.Metadata.public_distribution:type_name -> code.transaction.v2.PublicDistributionMetadata
	15,  // 51: code.transaction.v2.OpenAccountsMetadata.account_set:type_name -> code.transaction.v2.OpenAccountsMetadata.AccountSet
	89,  // 52: code.transaction.v2.OpenAccountsMetadata.mint:type_name -> code.common.v1.SolanaAccountId
	...
	89,  // 55: code.transaction.v2.SendPublicPaymentMetadata.destination_owner:type_name -> code.common.v1.SolanaAccountId
	59,  // 56: code.transaction.v2.SendPublicPaymentMetadata.exchange_data:type_name -> code.transaction.v2.ExchangeData
	89,  // 57: code.transaction.v2.SendPublicPaymentMetadata.mint:type_name -> code.common.v1.SolanaAccountId
	92,  // 58: code.transaction.v2.SendPublicPaymentMetadata.swap_id:type_name -> code.common.v1.SwapId
	89,  // 59: code.transaction.v2.ReceivePaymentsPubliclyMetadata.source:type_name -> code.common.v1.SolanaAccountId
	59,  // 60: code.transaction.v2.ReceivePaymentsPubliclyMetadata.exchange_data:type_name -> code.transaction.v2.ExchangeData
	89,  // 61: code.transaction.v2.ReceivePaymentsPubliclyMetadata.mint:type_name -> code.common.v1.SolanaAccountId
	89,  // 62: code.transaction.v2.PublicDistributionMetadata.source:type_name -> code.common.v1.SolanaAccountId
	87,  // 63: code.transaction.v2.PublicDistributionMetadata.distributions:type_name -> code.transaction.v2.PublicDistributionMetadata.Distribution
	89,  // 64: code.transaction.v2.PublicDistributionMetadata.mint:type_name -> code.common.v1.SolanaAccountId
	45,  // 65: code.transaction.v2.Action.open_account:type_name -> code.transaction.v2.OpenAccountAction
	46,  // 66: code.transaction.v2.Action.no_privacy_transfer:type_name -> code.transaction.v2.NoPrivacyTransferAction
	47,  // 67: code.transaction.v2.Action.no_privacy_withdraw:type_name -> code.transaction.v2.NoPrivacyWithdrawAction
	48,  // 68: code.transaction.v2.Action.fee_payment:type_name -> code.transaction.v2.FeePaymentAction
	93,  // 69: code.transaction.v2.OpenAccountAction.account_type:type_name -> code.common.v1.AccountType
	89,  // 70: code.transaction.v2.OpenAccountAction.owner:type_name -> code.common.v1.SolanaAccountId
	89,  // 71: code.transaction.v2.OpenAccountAction.authority:type_name -> code.common.v1.SolanaAccountId
	89,  // 72: code.transaction.v2.OpenAccountAction.token:type_name -> code.common.v1.SolanaAccountId
	90,  // 73: code.transaction.v2.OpenAccountAction.authority_signature:type_name -> code.common.v1.Signature
	89,  // 74: code.transaction.v2.OpenAccountAction.mint:type_name -> code.common.v1.SolanaAccountId
	89,  // 75: code.transaction.v2.NoPrivacyTransferAction.authority:type_name -> code.common.v1.SolanaAccountId
	89,  // 76: code.transaction.v2.NoPrivacyTransferAction.source:type_name -> code.common.v1.SolanaAccountId
	89,  // 77: code.transaction.v2.NoPrivacyTransferAction.destination:type_name -> code.common.v1.SolanaAccountId
	89,  // 78: code.transaction.v2.NoPrivacyTransferAction.mint:type_name -> code.common.v1.SolanaAccountId
	89,  // 79: code.transaction.v2.NoPrivacyWithdrawAction.authority:type_name -> code.common.v1.SolanaAccountId
	89,  // 80: code.transaction.v2.NoPrivacyWithdrawAction.source:type_name -> code.common.v1.SolanaAccountId
	89,  // 81: code.transaction.v2.NoPrivacyWithdrawAction.destination:type_name -> code.common.v1.SolanaAccountId
	89,  // 82: code.transaction.v2.NoPrivacyWithdrawAction.mint:type_name -> code.common.v1.SolanaAccountId
	16,  // 83: code.transaction.v2.FeePaymentAction.type:type_name -> code.transaction.v2.FeePaymentAction.FeeType
	89,  // 84: code.transaction.v2.FeePaymentAction.authority:type_name -> code.common.v1.SolanaAccountId
	89,  // 85: code.transaction.v2.FeePaymentAction.source:type_name -> code.common.v1.SolanaAccountId
	89,  // 86: code.transaction.v2.FeePaymentAction.mint:type_name -> code.common.v1.SolanaAccountId
	50,  // 87: code.transaction.v2.ServerParameter.nonces:type_name -> code.transaction.v2.NoncedTransactionMetadata
	51,  // 88: code.transaction.v2.ServerParameter.open_account:type_name -> code.transaction.v2.OpenAccountServerParameter
	52,  // 89: code.transaction.v2.ServerParameter.no_privacy_transfer:type_name -> code.transaction.v2.NoPrivacyTransferServerParameter
	53,  // 90: code.transaction.v2.ServerParameter.no_privacy_withdraw:type_name -> code.transaction.v2.NoPrivacyWithdrawServerParameter
	54,  // 91: code.transaction.v2.ServerParameter.fee_payment:type_name -> code.transaction.v2.FeePaymentServerParameter
	89,  // 92: code.transaction.v2.NoncedTransactionMetadata.nonce:type_name -> code.common.v1.SolanaAccountId
	94,  // 93: code.transaction.v2.NoncedTransactionMetadata.blockhash:type_name -> code.common.v1.Blockhash
	89,  // 94: code.transaction.v2.FeePaymentServerParameter.destination:type_name -> code.common.v1.SolanaAccountId
	56,  // 95: code.transaction.v2.ErrorDetails.reason_string:type_name -> code.transaction.v2.ReasonStringErrorDetails
	57,  // 96: code.transaction.v2.ErrorDetails.invalid_signature:type_name -> code.transaction.v2.InvalidSignatureErrorDetails
	58,  // 97: code.transaction.v2.ErrorDetails.denied:type_name -> code.transaction.v2.DeniedErrorDetails
	95,  // 98: code.transaction.v2.InvalidSignatureErrorDetails.expected_transaction:type_name -> code.common.v1.Transaction
	96,  // 99: code.transaction.v2.InvalidSignatureErrorDetails.expected_vixn_hash:type_name -> code.common.v1.Hash
	90,  // 100: code.transaction.v2.InvalidSignatureErrorDetails.provided_signature:type_name -> code.common.v1.Signature
	17,  // 101: code.transaction.v2.DeniedErrorDetails.code:type_name -> code.transaction.v2.DeniedErrorDetails.Code
	89,  // 102: code.transaction.v2.ExchangeData.mint:type_name -> code.common.v1.SolanaAccountId
	63,  // 103: code.transaction.v2.VerifiedSwapMetadata.currency_creator:type_name -> code.transaction.v2.VerifiedCurrencyCreatorSwapMetadata
	73,  // 104: code.transaction.v2.VerifiedCurrencyCreatorSwapMetadata.client_parameters:type_name -> code.transaction.v2.StartSwapRequest.Start.CurrencyCreator
	77,  // 105: code.transaction.v2.VerifiedCurrencyCreatorSwapMetadata.server_parameters:type_name -> code.transaction.v2.StartSwapResponse.ServerParameters.CurrencyCreator
	62,  // 106: code.transaction.v2.SwapMetadata.verified_metadata:type_name -> code.transaction.v2.VerifiedSwapMetadata
	18,  // 107: code.transaction.v2.SwapMetadata.state:type_name -> code.transaction.v2.SwapMetadata.State
	90,  // 108: code.transaction.v2.SwapMetadata.signature:type_name -> code.common.v1.Signature
	88,  // 109: code.transaction.v2.SubmitIntentRequest.SubmitActions.id:type_name -> code.common.v1.IntentId
	89,  // 110: code.transaction.v2.SubmitIntentRequest.SubmitActions.owner:type_name -> code.common.v1.SolanaAccountId
	39,  // 111: code.transaction.v2.SubmitIntentRequest.SubmitActions.metadata:type_name -> code.transaction.v2.Metadata
	44,  // 112: code.transaction.v2.SubmitIntentRequest.SubmitActions.actions:type_name -> code.transaction.v2.Action
	90,  // 113: code.transaction.v2.SubmitIntentRequest.SubmitActions.signature:type_name -> code.common.v1.Signature
	90,  // 114: code.transaction.v2.SubmitIntentRequest.SubmitSignatures.signatures:type_name -> code.common.v1.Signature
	49,  // 115: code.transaction.v2.SubmitIntentResponse.ServerParameters.server_parameters:type_name -> code.transaction.v2.ServerParameter
	2,   // 116: code.transaction.v2.SubmitIntentResponse.Success.code:type_name -> code.transaction.v2.SubmitIntentResponse.Success.Code
	3,   // 117: code.transaction.v2.SubmitIntentResponse.Error.code:type_name -> code.transaction.v2.SubmitIntentResponse.Error.Code
	55,  // 118: code.transaction.v2.SubmitIntentResponse.Error.error_details:type_name -> code.transaction.v2.ErrorDetails
	61,  // 119: code.transaction.v2.GetLimitsResponse.SendLimitsByCurrencyEntry.value:type_name -> code.transaction.v2.SendLimit
	73,  // 120: code.transaction.v2.StartSwapRequest.Start.currency_creator:type_name -> code.transaction.v2.StartSwapRequest.Start.CurrencyCreator
	90,  // 121: code.transaction.v2.StartSwapRequest.SubmitSignature.signatures:type_name -> code.common.v1.Signature
	92,  // 122: code.transaction.v2.StartSwapRequest.Start.CurrencyCreator.id:type_name -> code.common.v1.SwapId
	89,  // 123: code.transaction.v2.StartSwapRequest.Start.CurrencyCreator.from_mint:type_name -> code.common.v1.SolanaAccountId
	89,  // 124: code.transaction.v2.StartSwapRequest.Start.CurrencyCreator.to_mint:type_name -> code.common.v1.SolanaAccountId
	1,   // 125: code.transaction.v2.StartSwapRequest.Start.CurrencyCreator.funding_source:type_name -> code.transaction.v2.FundingSource
	77,  // 126: code.transaction.v2.StartSwapResponse.ServerParameters.currency_creator:type_name -> code.transaction.v2.StartSwapResponse.ServerParameters.CurrencyCreator
	9,   // 127: code.transaction.v2.StartSwapResponse.Success.code:type_name -> code.transaction.v2.StartSwapResponse.Success.Code
	10,  // 128: code.transaction.v2.StartSwapResponse.Error.code:type_name -> code.transaction.v2.StartSwapResponse.Error.Code
	55,  // 129: code.transaction.v2.StartSwapResponse.Error.error_details:type_name -> code.transaction.v2.ErrorDetails
	89,  // 130: code.transaction.v2.StartSwapResponse.ServerParameters.CurrencyCreator.nonce:type_name -> code.common.v1.SolanaAccountId
	94,  // 131: code.transaction.v2.StartSwapResponse.ServerParameters.CurrencyCreator.blockhash:type_name -> code.common.v1.Blockhash
	80,  // 132: code.transaction.v2.SwapRequest.Initiate.stateless:type_name -> code.transaction.v2.SwapRequest.Initiate.Stateless
	81,  // 133: code.transaction.v2.SwapRequest.Initiate.stateful:type_name -> code.transaction.v2.SwapRequest.Initiate.Stateful
	90,  // 134: code.transaction.v2.SwapRequest.SubmitSignatures.signatures:type_name -> code.common.v1.Signature
	89,  // 135: code.transaction.v2.SwapRequest.Initiate.Stateless.owner:type_name -> code.common.v1.SolanaAccountId
	89,  // 136: code.transaction.v2.SwapRequest.Initiate.Stateless.from_mint:type_name -> code.common.v1.SolanaAccountId
	89,  // 137: code.transaction.v2.SwapRequest.Initiate.Stateless.to_mint:type_name -> code.common.v1.SolanaAccountId
	89,  // 138: code.transaction.v2.SwapRequest.Initiate.Stateless.swap_authority:type_name -> code.common.v1.SolanaAccountId
	90,  // 139: code.transaction.v2.SwapRequest.Initiate.Stateless.signature:type_name -> code.common.v1.Signature
	92,  // 140: code.transaction.v2.SwapRequest.Initiate.Stateful.swap_id:type_name -> code.common.v1.SwapId
	89,  // 141: code.transaction.v2.SwapRequest.Initiate.Stateful.owner:type_name -> code.common.v1.SolanaAccountId
	89,  // 142: code.transaction.v2.SwapRequest.Initiate.Stateful.swap_authority:type_name -> code.common.v1.SolanaAccountId
	90,  // 143: code.transaction.v2.SwapRequest.Initiate.Stateful.signature:type_name -> code.common.v1.Signature
	85,  // 144: code.transaction.v2.SwapResponse.ServerParameters.currency_creator_stateless:type_name -> code.transaction.v2.SwapResponse.ServerParameters.CurrencyCreatorStateless
	86,  // 145: code.transaction.v2.SwapResponse.ServerParameters.currency_creator_stateful:type_name -> code.transaction.v2.SwapResponse.ServerParameters.CurrencyCreatorStateful
	13,  // 146: code.transaction.v2.SwapResponse.Success.code:type_name -> code.transaction.v2.SwapResponse.Success.Code
	14,  // 147: code.transaction.v2.SwapResponse.Error.code:type_name -> code.transaction.v2.SwapResponse.Error.Code
	55,  // 148: code.transaction.v2.SwapResponse.Error.error_details:type_name -> code.transaction.v2.ErrorDetails
	89,  // 149: code.transaction.v2.SwapResponse.ServerParameters.CurrencyCreatorStateless.payer:type_name -> code.common.v1.SolanaAccountId
	94,  // 150: code.transaction.v2.SwapResponse.ServerParameters.CurrencyCreatorStateless.recent_blockhash:type_name -> code.common.v1.Blockhash
	97,  // 151: code.transaction.v2.SwapResponse.ServerParameters.CurrencyCreatorStateless.alts:type_name -> code.common.v1.SolanaAddressLookupTable
	89,  // 152: code.transaction.v2.SwapResponse.ServerParameters.CurrencyCreatorStateless.memory_account:type_name -> code.common.v1.SolanaAccountId
	89,  // 153: code.transaction.v2.SwapResponse.ServerParameters.CurrencyCreatorStateful.payer:type_name -> code.common.v1.SolanaAccountId
	97,  // 154: code.transaction.v2.SwapResponse.ServerParameters.CurrencyCreatorStateful.alts:type_name -> code.common.v1.SolanaAddressLookupTable
	89,  // 155: code.transaction.v2.SwapResponse.ServerParameters.CurrencyCreatorStateful.memory_account:type_name -> code.common.v1.SolanaAccountId
	89,  // 156: code.transaction.v2.PublicDistributionMetadata.Distribution.destination:type_name -> code.common.v1.SolanaAccountId
	19,  // 157: code.transaction.v2.Transaction.SubmitIntent:input_type -> code.transaction.v2.SubmitIntentRequest
	21,  // 158: code.transaction.v2.Transaction.GetIntentMetadata:input_type -> code.transaction.v2.GetIntentMetadataRequest
	23,  // 159: code.transaction.v2.Transaction.GetLimits:input_type -> code.transaction.v2.GetLimitsRequest
	25,  // 160: code.transaction.v2.Transaction.CanWithdrawToAccount:input_type -> code.transaction.v2.CanWithdrawToAccountRequest
	27,  // 161: code.transaction.v2.Transaction.Airdrop:input_type -> code.transaction.v2.AirdropRequest
	29,  // 162: code.transaction.v2.Transaction.VoidGiftCard:input_type -> code.transaction.v2.VoidGiftCardRequest
	31,  // 163: code.transaction.v2.Transaction.StartSwap:input_type -> code.transaction.v2.StartSwapRequest
	33,  // 164: code.transaction.v2.Transaction.GetSwap:input_type -> code.transaction.v2.GetSwapRequest
	35,  // 165: code.transaction.v2.Transaction.GetPendingSwaps:input_type -> code.transaction.v2.GetPendingSwapsRequest
	37,  // 166: code.transaction.v2.Transaction.Swap:input_type -> code.transaction.v2.SwapRequest
	20,  // 167: code.transaction.v2.Transaction.SubmitIntent:output_type -> code.transaction.v2.SubmitIntentResponse
	22,  // 168: code.transaction.v2.Transaction.GetIntentMetadata:output_type -> code.transaction.v2.GetIntentMetadataResponse
	24,  // 169: code.transaction.v2.Transaction.GetLimits:output_type -> code.transaction.v2.GetLimitsResponse
	26,  // 170: code.transaction.v2.Transaction.CanWithdrawToAccount:output_type -> code.transaction.v2.CanWithdrawToAccountResponse
	28,  // 171: code.transaction.v2.Transaction.Airdrop:output_type -> code.transaction.v2.AirdropResponse
	30,  // 172: code.transaction.v2.Transaction.VoidGiftCard:output_type -> code.transaction.v2.VoidGiftCardResponse
	32,  // 173: code.transaction.v2.Transaction.StartSwap:output_type -> code.transaction.v2.StartSwapResponse
	34,  // 174: code.transaction.v2.Transaction.GetSwap:output_type -> code.transaction.v2.GetSwapResponse
	36,  // 175: code.transaction.v2.Transaction.GetPendingSwaps:output_type -> code.transaction.v2.GetPendingSwapsResponse
	38,  // 176: code.transaction.v2.Transaction.Swap:output_type -> code.transaction.v2.SwapResponse
	167, // [167:177] is the sub-list for method output_type
	157, // [157:167] is the sub-list for method input_type
...
func file_transaction_v2_transaction_service_proto_init() {
	...
	file_transaction_v2_transaction_service_proto_msgTypes[18].OneofWrappers = []interface{}{
		...
		(*SwapRequest_SubmitSignature)(nil),
	}
