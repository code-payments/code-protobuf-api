...
type IntentDeniedErrorDetails_Reason int32

const (
	// Reason not given and is obscured from client
	IntentDeniedErrorDetails_UNKNOWN IntentDeniedErrorDetails_Reason = 0
	// Phone number has exceeded its free account allocation
	IntentDeniedErrorDetails_TOO_MANY_FREE_ACCOUNTS_FOR_PHONE_NUMBER IntentDeniedErrorDetails_Reason = 1
	// Device has exceeded its free account allocation
	IntentDeniedErrorDetails_TOO_MANY_FREE_ACCOUNTS_FOR_DEVIEC IntentDeniedErrorDetails_Reason = 2
	// The country associated with the phone number with the account is not
	// supported (eg. it is on the sanctioned list).
	IntentDeniedErrorDetails_UNSUPPORTED_COUNTRY IntentDeniedErrorDetails_Reason = 3
	// The device is not supported (eg. it fails device attestation checks)
	IntentDeniedErrorDetails_UNSUPPORTED_DEVICE IntentDeniedErrorDetails_Reason = 4
)

// Enum value maps for IntentDeniedErrorDetails_Reason.
var (
	IntentDeniedErrorDetails_Reason_name = map[int32]string{
		0: "UNKNOWN",
	...
	IntentDeniedErrorDetails_Reason_value = map[string]int32{
		"UNKNOWN": 0,
...
func (x IntentDeniedErrorDetails_Reason) Enum() *IntentDeniedErrorDetails_Reason {
	p := new(IntentDeniedErrorDetails_Reason)
	*p = x
	return p
}

func (x IntentDeniedErrorDetails_Reason) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (IntentDeniedErrorDetails_Reason) Descriptor() protoreflect.EnumDescriptor {
	return file_transaction_v2_transaction_service_proto_enumTypes[16].Descriptor()
}

func (IntentDeniedErrorDetails_Reason) Type() protoreflect.EnumType {
	return &file_transaction_v2_transaction_service_proto_enumTypes[16]
}

func (x IntentDeniedErrorDetails_Reason) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use IntentDeniedErrorDetails_Reason.Descriptor instead.
func (IntentDeniedErrorDetails_Reason) EnumDescriptor() ([]byte, []int) {
...
func (x *ErrorDetails) GetIntentDenied() *IntentDeniedErrorDetails {
	if x, ok := x.GetType().(*ErrorDetails_IntentDenied); ok {
		return x.IntentDenied
	}
	return nil
}
...
type ErrorDetails_IntentDenied struct {
	IntentDenied *IntentDeniedErrorDetails `protobuf:"bytes,3,opt,name=intent_denied,json=intentDenied,proto3,oneof"` // Set when SubmitIntentResponse.Error.Code = DENIED
}
...
func (*ErrorDetails_IntentDenied) isErrorDetails_Type() {}
...
type IntentDeniedErrorDetails struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Reason IntentDeniedErrorDetails_Reason `protobuf:"varint,1,opt,name=reason,proto3,enum=code.transaction.v2.IntentDeniedErrorDetails_Reason" json:"reason,omitempty"`
}

func (x *IntentDeniedErrorDetails) Reset() {
	*x = IntentDeniedErrorDetails{}
	if protoimpl.UnsafeEnabled {
...
func (x *IntentDeniedErrorDetails) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IntentDeniedErrorDetails) ProtoMessage() {}

func (x *IntentDeniedErrorDetails) ProtoReflect() protoreflect.Message {
	mi := &file_transaction_v2_transaction_service_proto_msgTypes[53]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IntentDeniedErrorDetails.ProtoReflect.Descriptor instead.
func (*IntentDeniedErrorDetails) Descriptor() ([]byte, []int) {
	return file_transaction_v2_transaction_service_proto_rawDescGZIP(), []int{53}
}

func (x *IntentDeniedErrorDetails) GetReason() IntentDeniedErrorDetails_Reason {
	if x != nil {
		return x.Reason
	}
	return IntentDeniedErrorDetails_UNKNOWN
}
...
var file_transaction_v2_transaction_service_proto_rawDesc = []byte{
	...
	0xab, 0x02, 0x0a, 0x0c, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73,
	...
	0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x54, 0x0a, 0x0d, 0x69, 0x6e, 0x74, 0x65,
	0x6e, 0x74, 0x5f, 0x64, 0x65, 0x6e, 0x69, 0x65, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x2d, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x2e, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x2e, 0x76, 0x32, 0x2e, 0x49, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x44, 0x65, 0x6e, 0x69,
	0x65, 0x64, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x48, 0x00,
	0x52, 0x0c, 0x69, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x44, 0x65, 0x6e, 0x69, 0x65, 0x64, 0x42, 0x0d,
	...
	0x85, 0x02, 0x0a, 0x18, 0x49, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x44, 0x65, 0x6e, 0x69, 0x65, 0x64,
	0x45, 0x72, 0x72, 0x6f, 0x72, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x12, 0x4c, 0x0a, 0x06,
	0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x34, 0x2e, 0x63,
	0x6f, 0x64, 0x65, 0x2e, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2e,
	0x76, 0x32, 0x2e, 0x49, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x44, 0x65, 0x6e, 0x69, 0x65, 0x64, 0x45,
	0x72, 0x72, 0x6f, 0x72, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x2e, 0x52, 0x65, 0x61, 0x73,
	0x6f, 0x6e, 0x52, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x22, 0x9a, 0x01, 0x0a, 0x06, 0x52,
	...
	0x56, 0x49, 0x45, 0x43, 0x10, 0x02, 0x12, 0x17, 0x0a, 0x13, 0x55, 0x4e, 0x53, 0x55, 0x50, 0x50,
...
var file_transaction_v2_transaction_service_proto_goTypes = []interface{}{
	...
	(IntentDeniedErrorDetails_Reason)(0),                       // 16: code.transaction.v2.IntentDeniedErrorDetails.Reason
	...
	(*IntentDeniedErrorDetails)(nil),                           // 72: code.transaction.v2.IntentDeniedErrorDetails
...
var file_transaction_v2_transaction_service_proto_depIdxs = []int32{
	...
	72,  // 127: code.transaction.v2.ErrorDetails.intent_denied:type_name -> code.transaction.v2.IntentDeniedErrorDetails
	...
	16,  // 130: code.transaction.v2.IntentDeniedErrorDetails.reason:type_name -> code.transaction.v2.IntentDeniedErrorDetails.Reason
...
func file_transaction_v2_transaction_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_transaction_v2_transaction_service_proto_msgTypes[53].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*IntentDeniedErrorDetails); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
