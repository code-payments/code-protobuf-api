...
class MessagingClient extends \Grpc\BaseStub {
     ...
     * @param \Code\Messaging\V1\OpenMessageStreamRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\ServerStreamingCall
     */
    public function OpenMessageStream(\Code\Messaging\V1\OpenMessageStreamRequest $argument,
      $metadata = [], $options = []) {
        return $this->_serverStreamRequest('/code.messaging.v1.Messaging/OpenMessageStream',
        $argument,
        ['\Code\Messaging\V1\OpenMessageStreamResponse', 'decode'],
        $metadata, $options);
    }
     ...
     */
    public function OpenMessageStreamWithKeepAlive($metadata = [], $options = []) {
        return $this->_bidiRequest('/code.messaging.v1.Messaging/OpenMessageStreamWithKeepAlive',
        ['\Code\Messaging\V1\OpenMessageStreamWithKeepAliveResponse','decode'],
        $metadata, $options);
    }
     ...
     * @param \Code\Messaging\V1\PollMessagesRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function PollMessages(\Code\Messaging\V1\PollMessagesRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/code.messaging.v1.Messaging/PollMessages',
        $argument,
        ['\Code\Messaging\V1\PollMessagesResponse', 'decode'],
        $metadata, $options);
    }
     ...
     * the client.
     * @param \Code\Messaging\V1\AckMessagesRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function AckMessages(\Code\Messaging\V1\AckMessagesRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/code.messaging.v1.Messaging/AckMessages',
        $argument,
        ['\Code\Messaging\V1\AckMesssagesResponse', 'decode'],
        $metadata, $options);
    }

    /**
     * SendMessage sends a message.
     * @param \Code\Messaging\V1\SendMessageRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function SendMessage(\Code\Messaging\V1\SendMessageRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/code.messaging.v1.Messaging/SendMessage',
        $argument,
        ['\Code\Messaging\V1\SendMessageResponse', 'decode'],
        $metadata, $options);
    }
