...
namespace Code\Chat\V2\GetMessagesResponse;

use UnexpectedValueException;

/**
 * Protobuf type <code>code.chat.v2.GetMessagesResponse.Result</code>
 */
class Result
{
    /**
...
class_alias(Result::class, \Code\Chat\V2\GetMessagesResponse_Result::class);
