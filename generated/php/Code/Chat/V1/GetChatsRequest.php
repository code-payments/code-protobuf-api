...
/**
 * Generated from protobuf message <code>code.chat.v1.GetChatsRequest</code>
 */
class GetChatsRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>.code.chat.v1.GetChatsRequest.Direction direction = 5;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Code\Chat\V1\GetChatsRequest\Direction::class);
        $this->direction = $var;
