...
namespace Code\Chat\V1\ExchangeDataContent;

use UnexpectedValueException;

/**
 * Protobuf type <code>code.chat.v1.ExchangeDataContent.Verb</code>
 */
class Verb
{
    /**
...
class_alias(Verb::class, \Code\Chat\V1\ExchangeDataContent_Verb::class);
