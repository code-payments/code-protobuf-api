...
/**
 * Generated from protobuf message <code>code.micropayment.v1.RegisterWebhookRequest</code>
 */
class RegisterWebhookRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>string url = 2 [(.validate.rules) = {</code>
     */
    protected $url = '';
